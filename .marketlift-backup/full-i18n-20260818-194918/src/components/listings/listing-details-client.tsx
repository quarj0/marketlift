    ...
    return (
      <main className="mx-auto max-w-3xl px-4 py-12">
        <InlineError
          ...
          description="The connection failed before the listing could be loaded."
    ...
    return (
      <main className="mx-auto max-w-3xl px-4 py-12">
        <EmptyState
          ...
          description="It may have been removed, expired or the link may be incorrect."
          href="/search"
    ...
    <>
      <main className="mx-auto max-w-7xl px-4 py-5 pb-28 sm:px-6 sm:py-8 lg:px-8 lg:pb-8">
                ...
                <div className="marketlift-scrollbar flex gap-2 overflow-x-auto p-3 sm:p-4">
                  {listing.images.map((src, index) => (
                    <button
                      ...
                      className={`relative size-16 shrink-0 overflow-hidden rounded-xl border-2 sm:size-20 ${active === index ? "border-blue-600" : "border-transparent"}`}
                    >
                      <Image
                        src={src}
                        alt=""
          ...
          <aside className="self-start lg:sticky lg:top-32">
            {sellerQuery.isLoading ? (
              ...
              <InlineError
                ...
                description="The listing is available, but seller information could not be loaded."
              ...
              <div className="rounded-2xl border bg-white p-5 shadow-sm sm:rounded-3xl">
                ...
                <div className="mt-4 space-y-2">
                  ...
                  >
                    ...
                    {phoneVisible ? "+55 11 99876-4321" : "Show contact"}
                  </Button>
                  <Button
                    variant="ghost"
                    className="w-full"
            ...
            <div className="mt-4 rounded-2xl border border-amber-200 bg-amber-50 p-4 text-sm leading-6 text-amber-950">
              <div className="flex gap-2">
                ...
                <p>
                  <strong>Stay safe.</strong> Avoid advance payments. Check the
                  item and seller before completing any transaction. Marketlift
                  does not hold seller funds in V1.
                </p>
              </div>
            </div>
          </aside>
        ...
        <section className="mt-12">
          <div className="flex items-end justify-between gap-4">
            <div>
              <p className="text-sm font-bold text-blue-700">Keep browsing</p>
          ...
          {similarQuery.isLoading ? (
            ...
            <div className="mt-5">
              <InlineError
                title="Similar listings unavailable"
                description="You can still browse the rest of the marketplace."
            ...
            <div className="mt-5">
              <EmptyState
                ...
                description="Try browsing the category to discover more options."
                href={`/search?category=${listing.category}`}
      ...
      <div className="fixed inset-x-0 bottom-0 z-40 grid grid-cols-[1fr_1.4fr] gap-2 border-t bg-white/98 p-3 pb-[max(.75rem,env(safe-area-inset-bottom))] shadow-[0_-8px_30px_rgba(15,23,42,.08)] backdrop-blur lg:hidden">
        <Button variant="outline" onClick={() => setPhoneVisible(true)}>
          <Phone className="size-4" />
          {phoneVisible ? "Call seller" : "Contact"}
        </Button>
        <Button
          onClick={() =>
            requireAuth("message the seller", () => {
