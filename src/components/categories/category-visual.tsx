...
const photoGroups: Array<{ asset: string; ids: string[] }> = [
  ...
  { asset: "furniture", ids: ["furniture"] },
  { asset: "home-decor", ids: ["home-decor"] },
  { asset: "lighting", ids: ["lighting"] },
  ...
  {
    asset: "fashion",
    ids: ["fashion", "other-fashion"],
  },
  { asset: "womens-fashion", ids: ["womens-fashion"] },
  { asset: "mens-fashion", ids: ["mens-fashion"] },
  {
  ...
  { asset: "skincare", ids: ["skincare"] },
  { asset: "haircare", ids: ["haircare"] },
  { asset: "makeup", ids: ["makeup"] },
  { asset: "fragrances", ids: ["fragrances"] },
  { asset: "personal-care", ids: ["personal-care"] },
  {
    asset: "babies-kids",
    ids: [
      "babies-kids",
  ...
  { asset: "shoes", ids: ["shoes"] },
  { asset: "bags-accessories", ids: ["bags-accessories"] },
  { asset: "watches-jewelry", ids: ["watches-jewelry"] },
  { asset: "childrens-clothing", ids: ["childrens-clothing"] },
  { asset: "baby-clothing", ids: ["baby-clothing"] },
  { asset: "baby-gear", ids: ["baby-gear"] },
  { asset: "maternity", ids: ["maternity"] },
  { asset: "feeding", ids: ["feeding"] },
  { asset: "nursery", ids: ["nursery"] },
  { asset: "birds", ids: ["birds"] },
  { asset: "livestock", ids: ["livestock", "livestock-poultry"] },
  { asset: "pet-supplies", ids: ["pet-supplies"] },
  { asset: "farm-machinery", ids: ["farm-machinery"] },
  { asset: "animal-feed", ids: ["animal-feed"] },
  { asset: "doors-windows", ids: ["doors-windows"] },
  { asset: "roofing", ids: ["roofing"] },
  { asset: "restaurant-equipment", ids: ["restaurant-equipment"] },
  { asset: "office-equipment", ids: ["office-equipment"] },
  { asset: "medical-equipment", ids: ["medical-equipment"] },
  { asset: "printing-equipment", ids: ["printing-equipment"] },
  { asset: "power-tools", ids: ["power-tools"] },
  { asset: "hand-tools", ids: ["hand-tools"] },
  { asset: "generators", ids: ["generators"] },
  { asset: "safety-equipment", ids: ["safety-equipment"] },
  { asset: "measuring-tools", ids: ["measuring-tools"] },
  { asset: "hobbies-collectibles", ids: ["hobbies-collectibles"] },
  { asset: "tickets-events", ids: ["tickets-events"] },
];
