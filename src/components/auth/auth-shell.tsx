...
export function AuthShell({
  ...
  return (
    <main
      id="main-content"
      className="min-h-screen bg-slate-50 lg:grid lg:grid-cols-[minmax(0,1fr)_minmax(420px,.85fr)]"
    >
      <section className="relative hidden overflow-hidden bg-[#02122f] p-10 text-white lg:flex lg:min-h-screen lg:flex-col lg:justify-between xl:p-14">
        ...
        />
        <div
          className="absolute -bottom-24 left-20 size-80 rounded-full bg-lift-400/10 blur-3xl"
          aria-hidden="true"
        />
      ...
      <section className="flex min-h-screen flex-col">
        <div className="bg-ink-950 px-4 pb-8 pt-5 lg:hidden">
          <div className="mx-auto flex max-w-xl flex-wrap items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <Link
                href="/"
                className="inline-flex min-h-11 items-center rounded-xl border border-white/15 px-3 py-2 text-sm font-bold text-white focus-visible:ring-2 focus-visible:ring-white"
              >
                {t("auth.browse")}
              </Link>
            </div>
