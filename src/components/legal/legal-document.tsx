...
const EFFECTIVE_EN = "Effective 24 September 2026";
const EFFECTIVE_PT = "Vigência: 24 de setembro de 2026";
...
const cookiesEn: LegalCopy = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        "Marketlift Company LTDA, CNPJ 69.204.820/0001-00, operates the Marketlift service. Marketlift currently relies primarily on first-party cookies that are necessary for the service to work securely. These cookies are not used to build advertising profiles.",
      ],
      bullets: [
...
const cookiesPt: LegalCopy = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        "A Marketlift Company LTDA, CNPJ 69.204.820/0001-00, opera o serviço Marketlift. O Marketlift utiliza principalmente cookies próprios estritamente necessários para o funcionamento seguro do serviço. Esses cookies não são usados para criar perfis publicitários.",
      ],
      bullets: [
