      ...
      >
        ...
        >
          ...
          <button
            ...
            aria-pressed={saved}
            className="absolute right-2.5 top-2.5 grid size-11 place-items-center rounded-full bg-white/95 text-slate-700 shadow-md transition hover:bg-white focus-visible:ring-2 focus-visible:ring-blue-500 disabled:opacity-60"
          >
        ...
        <div className="p-3 sm:p-4">
          ...
          <Link
            href={`/listing/${listing.slug}`}
            className={`mt-1 line-clamp-2 block font-semibold leading-5 text-slate-800 hover:text-blue-700 ${list ? "text-lg" : "min-h-10 text-sm sm:min-h-12 sm:text-base"}`}
          >
            {listing.title}
          </Link>
          {list && (
