...
const VERIFICATION_FIELDS = `
  id sellerId sellerName identityCountryCode identityType identityMasked cpfMasked legalName birthDate documentType
...
export const verificationService = {
  ...
  async submit(input: { identityNumber: string; identityType: string; countryCode: string; fullName: string; birthDate: string }) {
