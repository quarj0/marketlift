  ...
  return (
    <>
      <button
        ...
        className={`inline-flex items-center gap-2 rounded-xl text-left transition hover:bg-slate-100 ${
      ...
      {open && (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-label={t("location.dialogTitle")}
        >
          <button
            type="button"
          ...
          <div className="relative z-10 max-h-[88vh] w-full overflow-hidden rounded-t-3xl bg-white shadow-2xl sm:max-w-2xl sm:rounded-3xl">
            ...
            <div className="p-5">
              ...
              >
                <LocateFixed className="size-4 text-brand-700" />
                {t("location.useMine")}
              </Button>
                  ...
                  <div className="mt-2 flex flex-wrap gap-2">
                    {recentLocations.map((location) => (
                      <button
                        ...
                        className="rounded-full border px-3 py-2 text-sm font-medium hover:border-brand-300 hover:bg-brand-50"
                      >
