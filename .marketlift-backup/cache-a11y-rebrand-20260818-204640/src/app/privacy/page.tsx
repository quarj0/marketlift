...
const sections = [
  ...
  ['privacy.verification', 'privacy.verificationBody'],
  ['privacy.use', 'privacy.useBody'],
  ['privacy.providers', 'privacy.providersBody'],
  ['privacy.controls', 'privacy.controlsBody'],
] as const;
    ...
    <MarketplaceShell>
      <main className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="rounded-3xl border bg-white p-7 shadow-sm sm:p-10">
          ...
          <h1 className="mt-2 text-4xl font-black"><T id="privacy.title" /></h1>
